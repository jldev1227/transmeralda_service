                                    ...
                                    >
                                        ...
                                        <td className="whitespace-nowrap py-4 pl-4 pr-3 text-sm relative">
                                            ...
                                            <div className="text-gray-500">
                                                <div className="text-gray-900">{municipios.find(m => m["Código Municipio"] === service.origen_id)?.["Nombre Municipio"]}</div>
                                                <div className="text-gray-500 text-xs">{limitText(service.origen_especifico, 30)}</div>
                                            </div>
                                        </td>
                                        ...
                                        <td className="whitespace-nowrap px-3 py-4 text-sm">
                                            <div className="text-gray-900">
                                                {limitText(empresas.find(e => e.id === service.cliente_id)?.Nombre, 30) || ''}
                                            </div>
                                            <div className="text-gray-500 text-xs">
                                                NIT: {empresas.find(e => e.id === service.cliente_id)?.NIT || ''}
                                            </div>
                                        </td>

                                        <td className="whitespace-nowrap px-3 py-4 text-sm">
                                            <div className="text-gray-900">{vehiculos.find(v => v.id === service.vehiculo_id)?.placa}</div>
                                            <div className="text-gray-500 text-xs">{vehiculos.find(v => v.id === service.vehiculo_id)?.linea} {vehiculos.find(v => v.id === service.vehiculo_id)?.modelo}</div>
                                        </td>
                                        <td className="whitespace-nowrap px-3 py-4 text-sm">
                    ...
                    <div className="hidden sm:flex sm:flex-1 sm:items-center sm:justify-between">
                        <div>
                            <p className="text-sm text-gray-700">
                                ...
                                de <span className="font-medium">{services.length}</span> vehículos
                            </p>
                        </div>
                        <div>
