...
import { Conductor, Vehiculo } from "@/context/serviceContext";
import { apiClient } from "@/config/apiClient";
import { Documento } from "@/types";

export default function ModalDocumentosConductor({
  conductorData,
}: {
                ...
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    ...
                    <p className="text-sm text-gray-600 font-normal">
                      ...
                      Identificación: {conductorData.tipo_identificacion}:{" "}
                      {conductorData.numero_identificacion}
                    </p>
                  </div>
                </div>
              </ModalHeader>
