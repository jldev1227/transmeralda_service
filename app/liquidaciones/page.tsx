...
export default function ModalLiquidarServicios() {
    ...
    const handleSubmit = useCallback(async () => {
        try {
            ...
            if (!validarConsecutivo(consecutivoLiquidacion)) {
                addToast({
                    title: "Error",
                    description: "El consecutivo debe tener formato AA-0000 a AAAA-0000 (letras mayúsculas-números)",
                    color: "danger",
                });
                return;
            }
            ...
            const response = await apiClient.post('/api/liquidaciones_servicios', datosLiquidacion);
            ...
            if (error.response && error.response.data) {
                const mensaje = error.response.data.error || "Ocurrió un error al procesar la liquidación";
                addToast({
                    title: "Error",
                    description: mensaje,
                    color: "danger",
    ...
    }, [serviciosSeleccionados, consecutivoLiquidacion, fechaLiquidacion, handleReset, addToast]);
    ...
    return (
        ...
        <div className="p-6">
            ...
            <div className="border-t pt-4 flex justify-end space-x-3">
                ...
                <Button onPress={handleGoBack} radius="sm" variant="light" color="danger">
                    Cancelar
                </Button>
                <Button radius="sm" className="bg-emerald-600 text-white disabled:opacity-75 disabled:cursor-not-allowed" onPress={handleSubmit} disabled={serviciosSeleccionados.length === 0}>
